...
var CONFIG = {
  ...
  /* Zoho CRM API module names — update if your org uses custom API names */
  modules: {
    leads:       "Leads",
    accounts:    "Accounts",
    deals:       "Deals",
    projects:    "Projects",          /* Custom module */
    rfqs:        "RFQs",              /* Custom module */
    budgetPlans: "Budget_Estimation_Plans", /* Custom module */
    vendors:     "Vendors",           /* Custom module */
